...
interface IUserRepo {
    ...
    check(username:string, user_telephone:string, user_email:string): Promise<ResponseMessage>;
    findByEmail(email: string): Promise<AppUser | null>;
    findByTelephone(telephone: string): Promise<AppUser | null>;
    findByUsername(username: string): Promise<AppUser | null>;
    findByEmailOrTelephone(user_email_or_phone: string): Promise<AppUser | null>;
...
export class UserRepo implements IUserRepo {
    ...
    async  check(username:string, user_telephone:string, user_email:string): Promise<ResponseMessage> {
        try {
    ...
    async findByTelephone(telephone: string): Promise<AppUser | null> {
        try {
            return await AppUser.findOne({ where: { user_telephone: telephone } });
        } catch (error) {
    ...
    async findByEmailOrTelephone(user_email_or_phone: string): Promise<AppUser | null> {
