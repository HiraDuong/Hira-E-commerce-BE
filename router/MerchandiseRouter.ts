...
class MerchandiseRoutes extends BaseRoutes {
    routes(): void {
        ...
        this.router.delete(
            '/delete/:id',
            authenticateToken,
            MerchandiseController.deleteMerchandiseById,
        );
        // update merchandise by id
        this.router.put(
            '/update/:id',
            authenticateToken,
            MerchandiseController.updateMerchandiseById,
        );
        ...
        this.router.get(
            '/shop/:shop_id',
            MerchandiseController.getMerchandiseByShopId,
        );
        ...
        this.router.get(
            '/name/:name',
            MerchandiseController.getMerchandiseByName,
        );
        // get merchandise by tag id
        this.router.get(
            '/tag/:tag_id',
            MerchandiseController.getMerchandiseByTagId,
        );
    }
}
