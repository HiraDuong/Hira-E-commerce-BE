...
class UserController {
    ...
    async updateUser(req: Request, res: Response) {
        ...
        try {
            ...
            updated_user.user_email = req.body.user_email || updated_user.user_email;
            updated_user.user_avt = req.body.user_avt || updated_user.user_avt;
            updated_user.user_telephone = req.body.user_telephone || updated_user.user_telephone;
            if(req.body.password){
                updated_user.user_password = await bcrypt.hash(req.body.user_password, 10);
            }
            else updated_user.user_password = updated_user.user_password.toString();
